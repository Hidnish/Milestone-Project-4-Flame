...
class Order(models.Model):
    ...
    home_delivery_cost = models.DecimalField(max_digits=6, decimal_places=2, null=False, default=0)
    ...
    def update_total(self):
        ...
        if delivery_cost < settings.STANDARD_DELIVERY_COST_MIN:
            self.home_delivery_cost = settings.STANDARD_DELIVERY_COST_MIN
...
class OrderLineItem(models.Model):
    ...
    def __str__(self):
        return f'Product code: {self.product.code} on order {self.order.order_number}'
