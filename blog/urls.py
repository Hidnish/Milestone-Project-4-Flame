...
urlpatterns = [
    ...
    path('save_comment/<int:post_id>/',
         views.save_comment, name="save_comment"),
    path('delete_comment/<int:comment_id>/',
         views.delete_comment, name="delete_comment"),
    path('delete_last_comment/<int:post_id>/<int:user_id>',
         views.delete_last_comment, name="delete_last_comment"),
